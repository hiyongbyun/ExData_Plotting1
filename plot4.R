...
## Graph
par("mfrow" = c(2,2))
with(power_filtered_datetime_df, plot(datetime, Global_active_power, type = "l", xlab = "", ylab = "Global Active Power"))
with(power_filtered_datetime_df, plot(datetime, Voltage, type = "l"))
...
legend("topright", lty = 1, col = c("black", "red", "blue"), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), bty = "n", y.intersp = 0.5)
with(power_filtered_datetime_df, plot(datetime, Global_reactive_power, type = "l"))
